...
void main() {
  ...
  group('SmsService - Metodo sendOtp', () {
    ...
    test('Deve inviare email di simulazione se i dati sono validi e utente esiste', () async {
      // arrange
    ...
    test('Deve lanciare ArgumentError se il formato del telefono è errato', () async {
      // arrange
      ...
      verifyNever(mockEmailService.send(to: anyNamed('to'), subject: anyNamed('subject'), htmlContent: anyNamed('htmlContent')));
    });
    ...
    test('Deve lanciare Exception se il numero di telefono non esiste nel DB', () async {
      // arrange
